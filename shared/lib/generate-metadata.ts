...
export const generateOptimizedMetadata = async ({ productLink, categoryLink, subcategoryLink, footerUrl, profile, notAuth, catalog }: MetadataParams): Promise<Metadata> => {
  let title = "RIKSI";
